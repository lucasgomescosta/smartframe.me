...
db.collection('scenes').where('owner', '==', 'lucasgomes').onSnapshot(function (querySnapshot) {
  const docs = []
  querySnapshot.forEach((doc) => {
    console.log(`${doc.id} => `, doc.data())
    docs.push(doc.data())
     ...
     <div className='bg-gray-200 md:overflow-hidden'>
      <div className='px-4 py-16'>
        <div className='relative w-full md:max-w-2xl md:mx-auto text-center'>
          ...
          >
            A simple and smart tool that will your old tablet/phone
          </h1>
